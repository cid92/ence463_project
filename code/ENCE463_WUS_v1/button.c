...
extern void buttonPress(void) 
{
	...
	{
		testValue = 4;
		changeDutyPWM(1 , 70.00);
		RIT128x96x4StringDraw( " 4    ",  90, 80, 15);
	}
	// See if the select button was just pressed.
	if((ulDelta & 0x80) && !(g_ucSwitches & 0x80))
	{
		testValue = 5;
		RIT128x96x4StringDraw( " 5    ",  90, 80, 15);
